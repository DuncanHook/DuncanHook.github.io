...
[Image of the Alien vs the Boxer](../images/Swift Strike/ Alien vs Boxer)

<br>

(Code unavailable due to size constraints)
<br>
...
<ul>
  <li>
    This program takes in a list of names and then, after asking the user what size of groups they want, determines how many weeks it will take to every name on the list to host every other name at their 'house'. As well as showing all of the groups the program has made. This program is written in python and assigns each name as a node in a directed graph. <br> 
    Created as a group.
  </li>
</ul>
